...
public class TC002Test {
  ...
  public void tC002() {
    ...
    driver.findElement(By.cssSelector("a > .mb-3")).click();
    driver.findElement(By.cssSelector(".mfp-close")).click();
    {
      WebElement element = driver.findElement(By.cssSelector(".btn-light:nth-child(1)"));
    ...
    driver.findElement(By.cssSelector(".col-sm > .list-unstyled:nth-child(3) > li:nth-child(3)")).click();
